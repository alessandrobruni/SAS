...
The excel  has 4 sheet
    ...
    for each terminal ID shows infos on
        ...
        transaction (month, amount, number) in a column view
...
/*
define in SAS a simple format structure
for better display  months
*/
...
/*
Code for selecting the agency channel in the datawarehouse 
...
/*
Loads all POS onboarded by the A4U sales network
*/
proc sql;
create table a4u as
select * 
